	...
	return []Celebration{
		{
			...
			Date:             md.AshWednesday.Date,
			Grade:            GradeSolemnity,
			Level:            LevelSolemnity,
			Color:            md.AshWednesday.Color,
			IsFeastOfTheLord: false,
			IsMovable:        true,
		},
		{
			Name:             "Domingo de Ramos da Paixão do Senhor",
			Date:             md.PalmSunday.Date,
			Grade:            GradeSolemnity,
			Level:            LevelSolemnity,
			Color:            md.PalmSunday.Color,
			IsFeastOfTheLord: true,
			IsMovable:        true,
		},
		{
			Name:             "Sexta-feira Santa da Paixão do Senhor",
			Date:             md.GoodFriday.Date,
			Grade:            GradeSolemnity,
			Level:            LevelSolemnity,
			Color:            md.GoodFriday.Color,
			IsFeastOfTheLord: true,
			IsMovable:        true,
		},
		{
		...
		},
		{
			...
			Date:             md.AscensionOfTheLord.Date,
			Grade:            GradeSolemnity,
			Level:            LevelSolemnity,
			Color:            md.AscensionOfTheLord.Color,
			IsFeastOfTheLord: true,
			IsMovable:        true,
		},
		{
